...
namespace QuantumSchool.Controllers {
    public class StudentsController : Controller {
        ...
        public ActionResult Create([Bind(Include = "StudentID,Name,Age,GPA")] Student student) {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,Name,Age,GPA")] Student student) {
            if(ModelState.IsValid) {
